# RSS-SHORT-TRACK-REACT2025

Personal Projects for the Short Track 2025 course of the RS School
...
```bash
git clone https://github.com/NatashaSolntseva/epam-shorttrack-react.git
```
